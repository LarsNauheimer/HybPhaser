...
output_assess <- file.path(path_to_output_folder,paste("02_assessment", name_for_dataset_optimization_subset, sep=""))
dir.create(output_assess, showWarnings = F, recursive = T)
